...
export const faqData: FaqDataType = [
  ...
  {
    question: 'Ile kosztuje Maltańczyk?',
    answer: 'Cena pieska jest ustalana indywidualnie. Piesek na kolanka ma inną cenę niż piesek na wystawy.',
  },
  {
    question: 'Jaki chcrakter będzie miał mój Maltańczyk?',
    answer:
  ...
  {
    question: 'Czy wszystkie Maltańczyki mają zacieki?',
    answer:
  ...
  {
    question: 'Czy mogę rozmnożyć psa?',
    answer:
  ...
  {
    question: 'Czy mogę kupić psa na prezent?',
    answer:
  ...
  {
    question: 'Czy pierwsze spotkanie jest obowiązkowe?',
    answer:
  ...
  {
    question: 'Ile kosztuje utrzymanie Maltańczyka?',
    answer:
